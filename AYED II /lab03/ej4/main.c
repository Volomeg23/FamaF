...
int main(int argc, char *argv[]) {
    ...
    month_t max_rain[YEARS];

    max_temp_year(array, maxes);
    month_max_rain_per_year(array, max_rain);
    absolute_min_temp = min_temp(array);

    printf("La temp minima absoluta es: %d\n", absolute_min_temp);

    printf("Listado de temperatura maxima por año: \n");
    dump_year_array(maxes);

    printf("Listado de mes de maxima precipitacion por año:\n");
    dump_month_array(max_rain);
