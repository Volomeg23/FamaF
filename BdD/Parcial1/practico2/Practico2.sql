...
CREATE TABLE Continents (Name varchar(20) PRIMARY KEY,
                        Area int NOT NULL,
                        Mass_percent numeric(3,1) NOT NULL,
                        Most_populus_city varchar(30) UNIQUE);



CREATE TABLE country (Code char(3) PRIMARY KEY,
                     Name varchar(50)  NOT NULL,
                     Continent varchar(20)NOT NULL,
                     Region varchar(40) NOT NULL,
                     SurfaceArea numeric(10,2) NOT NULL,
                     IndepYear int,Population int NOT NULL,
                     LifeExpectancy numeric(3,1),
                     GNP numeric(10,2) NOT NULL,
                     GNPold numeric(10,2),
...
CREATE TABLE countrylanguage (CountryCode char(3),
                              Language varchar(30), 
                              IsOfficial char(1),
                              Percentage numeric(8,1),
...
ALTER TABLE country ADD FOREIGN KEY (Continent) REFERENCES Continents(Name);




INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('Africa','30370000','20.4','Cairo,Egypt');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('Antarctica','14000000 ','9.2','McMurdo Station');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('Asia','44579000','29.5','Mumbai,India');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('Europe','10180000','6.8','Instanbul, Turquia');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('North America','24709000','16.5','Ciudad de México,Mexico');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('Oceania','8600000','5.9','Sydney, Australia');
INSERT INTO Continents (Name,Area,Mass_percent,Most_populus_city) VALUES ('South America','17840000','12.0','São Paulo, Brazil');
...
INSERT INTO `countrylanguage` VALUES ('ZMB','Tongan','F',11.0);S
...
--3)
SELECT Name,Region,SurfaceArea,GovernmentForm FROM country ORDER BY SurfaceArea DESC LIMIT 10;
--4)
SELECT Name,IndepYear FROM country WHERE IndepYear IS NULL;
--5)
SELECT Language,IsOfficial FROM countrylanguage WHERE IsOfficial = 'T';
--6)
UPDATE countrylanguage SET Percentage = 100.0 WHERE CountryCode = 'AIA';
--7)
SELECT Name,District FROM city WHERE District = 'Córdoba';
--8)
DELETE FROM city WHERE District = 'Córdoba' AND CountryCode != 'ARG';
--SELECT FROM city WHERE District LIKE "%rdoba" AND CountryCode != 'ARG' // con esto mysql no me toma la tilde
--9)
SELECT Name FROM country WHERE HeadOfState LIKE '%John%';
--SELECT Name FROM country WHERE HeadOfState LIKE '%John %'; mas robusto para nombres con entremedio john osea johnson
--10)
